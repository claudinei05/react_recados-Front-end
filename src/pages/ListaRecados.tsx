...
const ErrendsList: React.FC = () => {
  ...
  const recDelete = useCallback((idErrands: string) => {
    dispatch(deleteRecados(idErrands));
  }, []);
      ...
      >
        <Grid>
          ...
          >
                    ...
                    <Card>
                      ...
                      <CardActions>
                        <Button
                          variant="outlined"
                          startIcon={<EditIcon />}
                          // onClick={() => handleClickOpen(item.idErrands)}
                        ></Button>
                        <Button
                          variant="outlined"
                          startIcon={<DeleteIcon />}
                          //  onClick={() => recDelete(item.idErrands)}
                        ></Button>
                        <Button
                          variant="outlined"
            ...
            <FormDialog open={open} close={handleClose} id={ids}></FormDialog>
          </Paper>
        </Grid>
      </Grid>
    </Grid>
